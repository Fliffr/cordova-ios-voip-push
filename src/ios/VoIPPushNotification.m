...
- (void)pushRegistry:(PKPushRegistry *)registry didReceiveIncomingPushWithPayload:(PKPushPayload *)payload forType:(NSString *)type
{
    ...
    NSLog(@"[objC] didReceiveIncomingPushWithPayload: %@", notificationMessage);
	...
	[additionalData setObject:[NSNumber numberWithBool:[[UIApplication sharedApplication] applicationState] != UIApplicationStateActive] forKey:@"startBackground"];
